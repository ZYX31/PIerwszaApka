...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonF.setOnClickListener{
            ...
            val nowaAktywnosc = Intent(applicationContext, SecondActivity::class.java)
        ...
        buttonT.setOnClickListener{
            val przekierowujedotrzy = Intent(applicationContext, ThirdActivity::class.java)
            startActivity(przekierowujedotrzy)
        }
    }
}
